...
const releaseAppPath = path.join(projectRoot, 'release/mac-arm64/IntentFlow.app/Contents/Resources/out');
...
const releaseAppDir = path.join(projectRoot, 'release/mac-arm64/IntentFlow.app');
